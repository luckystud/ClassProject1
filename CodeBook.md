...
* The value is a mean of all body acceleration observations relate to a single combination of subj_id and activity_name.
...
* The value is a mean of all gravity acceleration observations relate to a single combination of subj_id and activity_name.
* The value has been normalized to between -1 and 1
...
* The value is a mean of all gravity acceleration standard deviation relate to a single combination of subj_id and activity_name.
* The value has been normalized to between -1 and 1
...
* The value is a mean of all linear body acceleration signals relate to a single combination of subj_id and activity_name.
* The value has been normalized to between -1 and 1
...
* The value is a mean of all signals relate to a single combination of subj_id and activity_name.
* The value has been normalized to between -1 and 1
...
* The value is a mean of all standard deviations relate to a single combination of subj_id and activity_name.
* The value has been normalized to between -1 and 1
...
* The value is a mean of all angular velocities relate to a single combination of subj_id and activity_name.
* The value has been normalized to between -1 and 1
...
* The value is a mean of all angular velocity standard deviations relate to a single combination of subj_id and activity_name.
* The value has been normalized to between -1 and 1
...
* The value is a mean of all body acceleration magnitudes relate to a single combination of subj_id and activity_name.
* The value has been normalized to between -1 and 1

## tBodyAccMag-std()
* The accelerometer 3-axial raw body acceleration signal magnitude standard deviation
* The value is a mean of all body acceleration magnitude standard deviations relate to a single combination of subj_id and activity_name.
* The value has been normalized to between -1 and 1

## tGravityAccMag-mean()
* The accelerometer 3-axial raw gravity acceleration signal magnitude
* The value is a mean of all gravity acceleration magnitude relate to a single combination of subj_id and activity_name.
* The value has been normalized to between -1 and 1

## tGravityAccMag-std()
* The accelerometer 3-axial raw gravity acceleration signal magnitude standard deviation
* The value is a mean of all gravity acceleration magnitude standard deviation relate to a single combination of subj_id and activity_name.
* The value has been normalized to between -1 and 1
